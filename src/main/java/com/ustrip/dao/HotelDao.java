...
public interface HotelDao 
{
	...
	List<Map<String,Object>> selectPlansByDate(@Param("plan_id")int plan_id,@Param("room_number")int room_number,@Param("day_number")int day_number,@Param("check_in")String check_in,@Param("check_out")String check_out);
